    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <aside className="lg:col-span-4 space-y-6">
            <div className="bg-white rounded-xl shadow-xs border p-6">
              <div className="flex items-center justify-between mb-3">
                <h2 className="text-base font-semibold text-gray-800">最近会话</h2>
                ...
                <div className="space-y-2 max-h-[calc(100vh-240px)] overflow-y-auto pr-0.5">
                  {recentSessions.map((sess) => (
                    <button
                      ...
                      className="w-full text-left p-3 rounded-lg hover:bg-blue-50/40 hover:border-blue-200 border border-gray-100 flex flex-col gap-1 text-sm transition-colors group"
                    >
                      <span className="font-medium text-gray-800 group-hover:text-blue-600 line-clamp-2 leading-snug">
                        {sess.question}
                      </span>
          ...
          {/* Right Column: Question input & Hotlist */}
